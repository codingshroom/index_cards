...
class App:
    ...
    def create_left_frame():
        ...
        self.left_button_1 = ctk.CTkButton(self.left_frame, text="Start", command=self.start_bucket_button_event)
        self.left_button_1.grid(row=1, column=0, padx=20, pady=40)
        self.left_button_2 = ctk.CTkButton(self.left_frame, text="Learning", command=self.learning_bucket_button_event)
        self.left_button_2.grid(row=2, column=0, padx=20, pady=40)
        self.left_button_3 = ctk.CTkButton(self.left_frame, text="Three Correct", command=self.correct_bucket_button_event)
    ...
    def create_right_frame():
        ...
        self.right_button_1 = ctk.CTkButton(self.right_frame, text="Options", command=self.option_button_event)
    ...
    def press_start_bucket_button(logic):
        logic.change_to_start_bucket()

    def press_learning_bucket_button(logic):
        logic.change_to_learning_bucket()

    def press_three_correct_bucket_button(logic):
