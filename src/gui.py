...
class App(customtkinter.CTk):
    ...
    def create_sidebar_left(self):
        self.sidebar_left_frame = customtkinter.CTkFrame(self, width=140, corner_radius=0)
        self.sidebar_left_frame.grid(row=0, column=0, rowspan=4, sticky="nsew")
        self.sidebar_left_frame.grid_rowconfigure(4, weight=1)
        self.left_label = customtkinter.CTkLabel(self.sidebar_left_frame, text="Buckets", font=customtkinter.CTkFont(size=20, weight="bold"))
        self.left_label.grid(row=0, column=0, padx=20, pady=(20, 40))
        self.sidebar_left_button_1 = customtkinter.CTkButton(self.sidebar_left_frame, text="Start", command=self.start_bucket_button_event)
        self.sidebar_left_button_1.grid(row=1, column=0, padx=20, pady=40)
        self.sidebar_left_button_2 = customtkinter.CTkButton(self.sidebar_left_frame, text="Learning", command=self.learning_bucket_button_event)
        self.sidebar_left_button_2.grid(row=2, column=0, padx=20, pady=40)
        self.sidebar_left_button_3 = customtkinter.CTkButton(self.sidebar_left_frame, text="Three Correct", command=self.correct_bucket_button_event)
    ...
    def create_sidebar_right(self):
        ...
        self.left_label = customtkinter.CTkLabel(self.sidebar_right_frame, text="Menu", font=customtkinter.CTkFont(size=20, weight="bold"))
